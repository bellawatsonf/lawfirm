...
export default function FooterComponent() {
  return (
    ...
    <div className="bg-[#162C4F] pb-[43px]">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 px-[80px] py-[31px] md:py-[71px] bg-[#162C4F] border-b-[1px] border-b-solid border-b-[#3A4553]">
        <div>
          <img src={img} />
        </div>
        <div>
          ...
          <ul>
            <li className="text-[#D7D7D7] font-[Poppins] text-[14px] md:text-[20px] font-normal leading-[200%]">
              Legal Advice
            </li>
            <li className="text-[#D7D7D7] font-[Poppins] text-[14px] md:text-[20px] font-normal leading-[200%]">
              Legal Drafting
        ...
        <div>
          ...
          <p className="text-[#D7D7D7] font-[Poppins] text-[14px] md:text-[20px] font-normal leading-[200%] mb-[50px]">
      ...
      <div className="bg-[#162C4F] text-[#D1B06B] font-[Poppins] text-[14px] md:text-[20px] font-normal leading-[200%] text-center py-[25px] border-b-[1px] border-b-solid border-b-[#3A4553]">
