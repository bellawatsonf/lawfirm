  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="title" content="PETRONEUS SAYUDI & ASSOCIATES Lawfirm" />
      ...
      <div className="h-[auto] md:h-[100vh] bg-[url('/Hero.svg')] bg-cover w-[100%] md:w-full px-[20px] md:px-[0px] pb-[50px] ">
        <div className=" md:w-[35%] relative left-[0px] md:left-[80px] top-[40px] md:top-[100px] ">
          ...
          <Button
            type="primary"
            className="h-[40px] bg-[#E7C070] rounded-[999px] uppercase p-[8px 32px] text-[12px] md:text-[16px] font-semibold font-[Poppins]"
          >
            Hubungi Kami
          </Button>
        </div>
      ...
      <div className="text-[#E7C070] text-center text-[32px] md:text-[40px] font-semibold leading-[32px] font-[Poppins] py-[60px] md:py-[80px] px-[24px] md:px-[92px] bg-[#07152A]">
        {/* Vision & Mission */}
